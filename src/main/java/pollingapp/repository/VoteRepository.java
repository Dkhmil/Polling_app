...
public interface VoteRepository extends JpaRepository<Vote, Long> {
    ...
    List<ChoiceVoteCount> countByPollIdGroupedByChoiceId(@Param("pollIds") List<Long> pollIds);
    ...
    List<ChoiceVoteCount> countByPollIdGroupedByChoiceId(@Param("pollId") Long pollId);
